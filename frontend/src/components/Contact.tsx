          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 8425846304</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">G-2, Ground Floor, G Wing, KK Residency, Life Care Medical, Azad Nagar, Hill No. 4</p>
                    <p className="text-gray-600">Ghatkopar West, Mumbai - 400086</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://wa.me/919323263322"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white/20 backdrop-blur-sm p-4 rounded-lg hover:bg-white/30 transition-colors text-center"
                >
                  <MessageCircle className="h-8 w-8 mx-auto mb-2" />
                  <span className="text-sm font-medium">WhatsApp</span>
                </a>
                <a
                  href="tel:+919323263322"
                  className="bg-white/20 backdrop-blur-sm p-4 rounded-lg hover:bg-white/30 transition-colors text-center"
                >
